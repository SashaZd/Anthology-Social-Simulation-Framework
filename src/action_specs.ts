...
// Discuss: replace effect's motive:"physical" with Motive.physical
...
// {
//   name: "movie_action",
//   requirements: [{type:"location", req:{hasAllOf:["movie theatre"], hasOneOrMoreOf:[], hasNoneOf:[]}}],
...
// {
//   name: "work_action",
//   requirements: [{type:"location", req:{hasAllOf:["employment"], hasOneOrMoreOf:[], hasNoneOf:[]}}],
...
// {
//   name: "hobby_action",
//   requirements: [{type:"location", req:{hasAllOf:["home"], hasOneOrMoreOf:[], hasNoneOf:[]}}],
